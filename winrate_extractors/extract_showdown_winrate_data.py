...
Output schema matches ou_winrate_chunks (but saved to a different folder).
"""
...
def main() -> None:
    ...
    parser.add_argument("--base_name", default="ou_winrate_data", help="Output filename prefix")
